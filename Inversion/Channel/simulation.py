...
if __name__ == "__main__":
    ...
    dir = os.getcwd()
    plot=simulation()
    K = np.loadtxt(dir+f"/Channel/test_data/true_permeability_0.05.dat")
    t1 = time.time()
    ...
    # np.savetxt(dir+f'/Channel/test_data/obs_0.05.dat',u)
    # np.savetxt(dir+f'/Channel/test_data/sigma_0.05.dat',sigma)
    # np.savetxt(dir+f'/Channel/test_data/true_pressure_0.05.dat',pre)
    # np.savetxt(dir+f'/Channel/test_data/vx_0.05.dat',vx)
    # np.savetxt(dir+f'/Channel/test_data/vy_0.05.dat',vy)
    # np.savetxt(dir+f'/Channel/test_data/obs_position_0.05.dat',pos)
    ...
    plt.savefig(dir+f'/Channel/test_data/truth.pdf',bbox_inches = 'tight', dpi=1000,pad_inches=0.0)
    plt.close()
