...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp',type = str ,default = 'inversion_16_32_64',help = 'scale_size')
    args = parser.parse_args()
    device = torch.device("cuda:3" if torch.cuda.is_available() else "cpu")
    latent_c = latent_c(device)
    mean_c = np.loadtxt(os.getcwd()+f'/Channel/prediction/inversion_16_32/mean.dat')
    init_c=latent_c.coarse_latent(args.exp,mean_c).reshape(80,)
    ...
    # plot error bar #
    filename = '/channel_16_32_64_errorbar.pdf'
