...
if __name__ == "__main__":
    ...
    parser.add_argument('--steps',type = int ,default = 10000,help = 'steps')
    parser.add_argument('--burn_in',type = int ,default = 8000,help = 'burn_in')
    ...
    # plot error bar #
    filename = '/gaussian_64_errorbar.pdf'
