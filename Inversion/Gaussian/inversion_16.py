...
if __name__ == "__main__":
    ...
    parser.add_argument('--dim',type = int ,default = 16,help = 'dim of prams')
    ...
    parser.add_argument('--scale',type = str ,default = 'scale_16',help = 'scale_size')
    parser.add_argument('--noise',type = str ,default = '0.05',help = 'scale_size')
    parser.add_argument('--exp',type = str ,default = 'inversion_16',help = 'scale_size')
